...
var SentimeterComponent = /** @class */ (function () {
    ...
    SentimeterComponent.prototype.renderMoreFeedback = function () {
        var _this = this;
        return (h("div", null, this.renderQuestion(), h("div", { class: "modal " + (this.showModal ? 'show-modal' : '') }, h("div", { class: "modal-content" }, h("span", { class: "close-button" }, "\u00D7"), h("div", null, h("p", { class: "c-font" }, "What did you like most?"), h("textarea", { class: "textarea", rows: 4, cols: 50 })), h("div", null, h("p", { class: "c-font" }, "What did you like least?"), h("textarea", { class: "textarea", rows: 4, cols: 50 })), h("div", null, h("p", { class: "c-font" }, "Your email (optional)"), h("input", { class: "input", type: "email" })), h("div", { class: "btn-block" }, h("button", { class: "btn btn-transparent", onClick: function () { return _this.handleSubmitClick(); } }, "CANCEL"), h("button", { class: "btn btn-primary", onClick: function () { return _this.handleSubmitClick(); } }, "SUBMIT")))), h("div", { class: "modal " + (this.showThankYouModal ? 'show-modal' : '') }, h("div", { class: "modal-content" }, h("span", { class: "close-button" }, "\u00D7"), h("div", { class: "thank-you-container" }, h("h1", { class: "c-font" }, "Thank you!"), h("p", { class: "c-font" }, "Your feedback is valuable to us."))))));
    };
    ...
    Object.defineProperty(SentimeterComponent, "style", {
        get: function () { return "html.sc-gt-sentimeter{line-height:1.15;-webkit-text-size-adjust:100%}body.sc-gt-sentimeter{margin:0}h1.sc-gt-sentimeter{font-size:2em;margin:.67em 0}hr.sc-gt-sentimeter{-webkit-box-sizing:content-box;box-sizing:content-box;height:0;overflow:visible}code.sc-gt-sentimeter, kbd.sc-gt-sentimeter, pre.sc-gt-sentimeter, samp.sc-gt-sentimeter{font-family:monospace,monospace;font-size:1em}a.sc-gt-sentimeter{background-color:transparent}abbr[title].sc-gt-sentimeter{border-bottom:none;text-decoration:underline;-webkit-text-decoration:underline dotted;text-decoration:underline dotted}b.sc-gt-sentimeter, strong.sc-gt-sentimeter{font-weight:bolder}small.sc-gt-sentimeter{font-size:80%}sub.sc-gt-sentimeter, sup.sc-gt-sentimeter{font-size:75%;line-height:0;position:relative;vertical-align:baseline}sub.sc-gt-sentimeter{bottom:-.25em}sup.sc-gt-sentimeter{top:-.5em}img.sc-gt-sentimeter{border-style:none}button.sc-gt-sentimeter, input.sc-gt-sentimeter, optgroup.sc-gt-sentimeter, select.sc-gt-sentimeter, textarea.sc-gt-sentimeter{font-family:inherit;font-size:100%;line-height:1.15;margin:0}button.sc-gt-sentimeter, input.sc-gt-sentimeter{overflow:visible}button.sc-gt-sentimeter, select.sc-gt-sentimeter{text-transform:none}[type=button].sc-gt-sentimeter, [type=reset].sc-gt-sentimeter, [type=submit].sc-gt-sentimeter, button.sc-gt-sentimeter{-webkit-appearance:button}[type=button].sc-gt-sentimeter::-moz-focus-inner, [type=reset].sc-gt-sentimeter::-moz-focus-inner, [type=submit].sc-gt-sentimeter::-moz-focus-inner, button.sc-gt-sentimeter::-moz-focus-inner{border-style:none;padding:0}[type=button].sc-gt-sentimeter:-moz-focusring, [type=reset].sc-gt-sentimeter:-moz-focusring, [type=submit].sc-gt-sentimeter:-moz-focusring, button.sc-gt-sentimeter:-moz-focusring{outline:ButtonText dotted 1px}fieldset.sc-gt-sentimeter{padding:.35em .75em .625em}legend.sc-gt-sentimeter{-webkit-box-sizing:border-box;box-sizing:border-box;color:inherit;display:table;max-width:100%;padding:0;white-space:normal}progress.sc-gt-sentimeter{vertical-align:baseline}textarea.sc-gt-sentimeter{overflow:auto}[type=checkbox].sc-gt-sentimeter, [type=radio].sc-gt-sentimeter{-webkit-box-sizing:border-box;box-sizing:border-box;padding:0}[type=number].sc-gt-sentimeter::-webkit-inner-spin-button, [type=number].sc-gt-sentimeter::-webkit-outer-spin-button{height:auto}[type=search].sc-gt-sentimeter{-webkit-appearance:textfield;outline-offset:-2px}[type=search].sc-gt-sentimeter::-webkit-search-decoration{-webkit-appearance:none}.sc-gt-sentimeter::-webkit-file-upload-button{-webkit-appearance:button;font:inherit}details.sc-gt-sentimeter{display:block}summary.sc-gt-sentimeter{display:list-item}[hidden].sc-gt-sentimeter, template.sc-gt-sentimeter{display:none}*.sc-gt-sentimeter{font-family:\"Helvetica Neue\",serif}.gt-sentimeter.sc-gt-sentimeter{display:-webkit-box;display:-ms-flexbox;display:flex;position:fixed;z-index:999;bottom:10px;left:20px;-webkit-transition:all .5s;transition:all .5s;background-color:#11767e;color:#fff;padding:10px;border-radius:50px;width:35px;height:35px;text-align:center;margin:0 auto}.gt-sentimeter-rating.sc-gt-sentimeter{width:400px;height:50px}.gt-sentimeter-more.sc-gt-sentimeter{width:670px;height:50px}.pointer.sc-gt-sentimeter{cursor:pointer}.gt-sentimeter-wrapper.sc-gt-sentimeter{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:stretch;-ms-flex-align:stretch;align-items:stretch}.gt-sentimeter-toggle.sc-gt-sentimeter{width:200px}path.sc-gt-sentimeter{fill:#fff}.gt-sentimeter-text.sc-gt-sentimeter{font-size:16px;margin:0 0 0 10px;line-height:2.3;white-space:nowrap}.gt-sentimeter-thumb.sc-gt-sentimeter{cursor:pointer;background-color:rgba(0,0,0,.3);width:50px;height:50px;border-radius:50px;-webkit-transition:all .5s;transition:all .5s;line-height:3.8;margin:0 10px}.thumb-flip.sc-gt-sentimeter{-webkit-transform:scaleY(-1);transform:scaleY(-1)}.btn.sc-gt-sentimeter{border-radius:5px;padding:2px 20px;font-weight:700;font-size:18px;font-family:Arial,Helvetica,sans-serif}.btn-primary.sc-gt-sentimeter{background-color:#fff;color:#11767e;-webkit-box-shadow:5px 10px 9px -6px rgba(0,0,0,.28);-moz-box-shadow:5px 10px 9px -6px rgba(0,0,0,.28);box-shadow:5px 10px 9px -6px rgba(0,0,0,.28)}.btn-transparent.sc-gt-sentimeter{color:#fff;background-color:transparent;border-color:transparent}.btn-block.sc-gt-sentimeter{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:justify;-ms-flex-pack:justify;justify-content:space-between;-webkit-box-align:stretch;-ms-flex-align:stretch;align-items:stretch;height:40px;margin-top:20px;padding-bottom:30px}.thank-you-container.sc-gt-sentimeter{text-align:center;padding:0 30px}.thank-you-container.sc-gt-sentimeter > h1.sc-gt-sentimeter{margin-bottom:0}.modal.sc-gt-sentimeter{z-index:1000;position:fixed;left:0;top:0;width:100%;height:100%;background-color:rgba(0,0,0,.5);opacity:0;visibility:hidden;-webkit-transform:scale(1.1);transform:scale(1.1);-webkit-transition:visibility 0s linear .25s,opacity .25s 0s,-webkit-transform .25s;transition:visibility 0s linear .25s,opacity .25s 0s,-webkit-transform .25s;transition:visibility 0s linear .25s,opacity .25s 0s,transform .25s;transition:visibility 0s linear .25s,opacity .25s 0s,transform .25s,-webkit-transform .25s}.modal-content.sc-gt-sentimeter{position:absolute;top:50%;left:50%;-webkit-transform:translate(-50%,-50%);transform:translate(-50%,-50%);background-color:#11767e;color:#fff;padding:1rem 1.5rem;border-radius:.5rem}.textarea.sc-gt-sentimeter{font-size:1rem;line-height:1.5;color:#495057;border:1px solid #ced4da;border-radius:.25rem}.input.sc-gt-sentimeter{display:block;width:100%;height:40px;font-size:1rem;line-height:1.5;color:#495057;border:1px solid #ced4da;border-radius:.25rem}.close-button.sc-gt-sentimeter{float:right;width:1.5rem;line-height:1.5rem;text-align:center;cursor:pointer;border-radius:.25rem;color:#fff}.close-button.sc-gt-sentimeter:hover{background-color:#a9a9a9}.show-modal.sc-gt-sentimeter{opacity:1;visibility:visible;-webkit-transform:scale(1);transform:scale(1);-webkit-transition:visibility 0s linear 0s,opacity .25s 0s,-webkit-transform .25s;transition:visibility 0s linear 0s,opacity .25s 0s,-webkit-transform .25s;transition:visibility 0s linear 0s,opacity .25s 0s,transform .25s;transition:visibility 0s linear 0s,opacity .25s 0s,transform .25s,-webkit-transform .25s}"; },
        enumerable: true,
        configurable: true
    });
